...
export const OfflineServersDialog: React.FC = () => (
  <Dialog open={false} fullScreen={true}>
    <Box style={{ maxWidth: 500, position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
      ...
      <DialogContent>
        <DialogContentText>
          You can&apos;t connect to the server. Try later or report it to our support for e-mail: support@microblog.com
          . Thanks for all feedback and we apologize for the problems!
        </DialogContentText>
      </DialogContent>
    </Box>
  </Dialog>
